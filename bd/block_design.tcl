...
# module references:
# awg_BRAM_dual, control_or_gate, pmod_test
...
proc create_root_design { parentCell } {
  ...
  set dac0_clk_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 dac0_clk_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {491516000.0} \
   ] $dac0_clk_1
  ...
  # Create ports
  set control_trigger_0 [ create_bd_port -dir I control_trigger_0 ]
  set pmod_out_0 [ create_bd_port -dir O pmod_out_0 ]

  # Create instance: MAX_POINTS, and set properties
  set MAX_POINTS [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 MAX_POINTS ]
  set_property -dict [list \
  ...
  # Create instance: awg_BRAM_dual_0, and set properties
  set block_name awg_BRAM_dual
  set block_cell_name awg_BRAM_dual_0
  if { [catch {set awg_BRAM_dual_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $awg_BRAM_dual_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: axi_control, and set properties
  set axi_control [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_control ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: control_or_gate_0, and set properties
  set block_name control_or_gate
  set block_cell_name control_or_gate_0
  if { [catch {set control_or_gate_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $control_or_gate_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: enable_ch0, and set properties
  set enable_ch0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 enable_ch0 ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: enable_ch2, and set properties
  set enable_ch2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 enable_ch2 ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_DOUT_DEFAULT {0x00000001} \
    CONFIG.C_GPIO_WIDTH {1} \
  ...
  # Create instance: pmod_test_0, and set properties
  set block_name pmod_test
  set block_cell_name pmod_test_0
  if { [catch {set pmod_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pmod_test_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: rst_n, and set properties
  set rst_n [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 rst_n ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_GPIO_WIDTH {1} \
  ] $rst_n
  ...
  set write_enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 write_enable ]
  set_property -dict [list \
...
\
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {214.285675} \
...
\
  ...
  connect_bd_intf_net -intf_net MAX_POINTS_GPIO [get_bd_intf_ports gpio_rtl] [get_bd_intf_pins MAX_POINTS/GPIO]
  connect_bd_intf_net -intf_net awg_BRAM_dual_0_m00_axis_0 [get_bd_intf_pins awg_BRAM_dual_0/m00_axis] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  connect_bd_intf_net -intf_net awg_BRAM_dual_0_m00_axis_1 [get_bd_intf_pins awg_BRAM_dual_0/m22_axis] [get_bd_intf_pins usp_rf_data_converter_0/s20_axis]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports dip_switches_4bits] [get_bd_intf_pins write_enable/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports gpio_rtl_0] [get_bd_intf_pins axi_control/GPIO]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins awg_BRAM_dual_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  connect_bd_intf_net -intf_net dac0_clk_1_1 [get_bd_intf_ports dac0_clk_1] [get_bd_intf_pins usp_rf_data_converter_0/dac0_clk]
  connect_bd_intf_net -intf_net dac2_clk_1_1 [get_bd_intf_ports dac2_clk_1] [get_bd_intf_pins usp_rf_data_converter_0/dac2_clk]
  connect_bd_intf_net -intf_net enable_ch0_GPIO [get_bd_intf_ports gpio_rtl_1] [get_bd_intf_pins enable_ch0/GPIO]
  connect_bd_intf_net -intf_net enable_ch2_GPIO [get_bd_intf_ports gpio_rtl_2] [get_bd_intf_pins enable_ch2/GPIO]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins write_enable/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins MAX_POINTS/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins rst_n/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_control/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins enable_ch0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins enable_ch2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net MAX_POINTS_gpio_io_o [get_bd_pins MAX_POINTS/gpio_io_o] [get_bd_pins awg_BRAM_dual_0/MAX_POINTS]
  connect_bd_net -net axi_control [get_bd_pins axi_control/gpio_io_o] [get_bd_pins control_or_gate_0/axi_control]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins proc_sys_reset_2/aux_reset_in] [get_bd_pins rst_n/gpio_io_o]
  connect_bd_net -net control_or_gate_0_control_trigger [get_bd_pins awg_BRAM_dual_0/control_trigger] [get_bd_pins control_or_gate_0/control_trigger]
  connect_bd_net -net control_trigger_0_1 [get_bd_ports control_trigger_0] [get_bd_pins control_or_gate_0/external_control] [get_bd_pins pmod_test_0/pmod_in]
  connect_bd_net -net enable_ch0_gpio_io_o [get_bd_pins awg_BRAM_dual_0/enable_ch0] [get_bd_pins enable_ch0/gpio_io_o]
  connect_bd_net -net enable_ch2_gpio_io_o [get_bd_pins awg_BRAM_dual_0/enable_ch2] [get_bd_pins enable_ch2/gpio_io_o]
  connect_bd_net -net pmod_test_0_pmod_out [get_bd_ports pmod_out_0] [get_bd_pins pmod_test_0/pmod_out]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins awg_BRAM_dual_0/rst_n] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins MAX_POINTS/s_axi_aresetn] [get_bd_pins axi_control/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins enable_ch0/s_axi_aresetn] [get_bd_pins enable_ch2/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_n/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins write_enable/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_dac2] [get_bd_pins util_ds_buf_1/BUFG_I]
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins awg_BRAM_dual_0/m00_axis_aclk] [get_bd_pins pmod_test_0/clk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins util_ds_buf_0/BUFG_O]
  connect_bd_net -net util_ds_buf_1_BUFG_O [get_bd_pins awg_BRAM_dual_0/m22_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk] [get_bd_pins util_ds_buf_1/BUFG_O]
  connect_bd_net -net write_enable_gpio_io_o [get_bd_pins awg_BRAM_dual_0/write_enable] [get_bd_pins write_enable/gpio_io_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins MAX_POINTS/s_axi_aclk] [get_bd_pins awg_BRAM_dual_0/m_axis_clk] [get_bd_pins axi_control/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins enable_ch0/s_axi_aclk] [get_bd_pins enable_ch2/s_axi_aclk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_n/s_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins write_enable/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MAX_POINTS/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs write_enable/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs rst_n/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_control/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs enable_ch0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs enable_ch2/S_AXI/Reg] -force
